...
class GovSpider:
    ...
    def __init__(self):
        ...
        self.base_path = '/home/xmaihh/Desktop/gov_spider/' + self.spath
    ...
    def download_imgs(self, html):
        ...
        if liResult:
            ...
            for img_li in liResult:
                if img_li and ('{' not in img_li and '</' not in img_li) and (
                        '.jpg' in img_li or '.ico' in img_li or '.png' in
                        img_li or '.svg' in img_li or '.gif' in img_li or '.webp' in img_li or 'data:image' in img_li):

                    if '\/' not in img_li:
                        img_urls = [re.sub('[";]|(.*=)|(.*\()|(\).*)|(")', '', img_li)]
                    else:
